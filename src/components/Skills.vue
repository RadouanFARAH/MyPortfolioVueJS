<template >
     <div>
             <div class="skills-content">
                ...
                <div class="chart-container" v-show="chart==2">
                   <canvas id="graphicsChart"  width="300" height="300"></canvas>
                </div>
...
Chart.defaults.global.defaultStrokeColor = 'black';
  ...
  export default {
    ...
    mounted(){
      ...
      var graphicsChart = new Chart(ctx2, {
        type: 'radar',
        data: {
